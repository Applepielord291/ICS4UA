...
public class Main {
    ...
    {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("SortingAlgorithmTypes/src/unsorted.txt")))
        {
        ...
        if (currentSearchChoice != 0 || currentSearchChoice != 3)
        {
            ...
            if (currentSearchChoice == 2)
            {
                ...
                while (first <= last) //cols
                {
                    ...
                    else if (array[mid] > key) last = mid-1; //eliminate right half
                    else if (array[mid] < key) first = mid+1; //eliminate left half
    ...
    {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("SortingAlgorithmTypes/src/sorted.txt")))
        {
