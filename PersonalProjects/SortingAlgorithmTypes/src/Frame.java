...
public class Frame {
    ...
    public static void displayInitArr(int arrSize) throws IOException
    {
        try 
        {
            init.read(new BufferedReader(new FileReader("SortingAlgorithmTypes\\src\\unsorted.txt")), null);
        }
        catch (Exception e)
        {
            errorPopUp(e);
    ...
    public static void displaySortArr()
    {
        try
        {
            fin.read(new BufferedReader(new FileReader("SortingAlgorithmTypes\\src\\sorted.txt")), null);
        }
        catch (Exception e)
        {
            errorPopUp(e);
